...
<body>
    <body>
        ...
        <div class="text-center mt-4">
            <strong><p class="fs-2">ประวัติการทำรายการ</p></strong>
        </div>
        <?php if($rb>0) {  ?>  
        <div class='container-fluid d-flex justify-content-center table-responsive mt-3'>
            <table class="table table-bordered w-auto">
                ...
                ?>
                <tbody>
                    <?php if($r->detail_status == 3 or $r->detail_status == 2){
                        ?>    
                        ...
                        <td width="200" ><?php echo $r->orders_phone?></td>
                       ...
                       <?php } ?></td>
                        ...
                        <?php if($r->detail_status == 3){?><td class=" bg bg-success text-center text-white ">
                            <div class="">สำเร็จการขาย</div></td>
                       <?php }else if($r->detail_status == 2){
                        ?><td class="  bg bg-danger text-center text-white ">
                            <div class="">ยกเลิกการสั่งซื้อ</div>
                        </td>    
                        <?php }}else{ 
